...
const courses = [
  {
    ...
    description:
      "Learn how open, high, low and close combine into a single candle, and what body size and wick length tell you about buyer/seller pressure.",
    level: "Beginner",
    duration: "12 min",
    lessons: 5,
  ...
  },
  {
    ...
    description:
      "A practical tour of doji, hammer, engulfing and pin bar patterns, with notes on where each tends to show up and how reliable it usually is.",
    level: "Beginner",
    duration: "18 min",
    lessons: 6,
    category: "Technical Analysis",
  ...
  },
  {
    ...
    description:
      "How leverage multiplies both gains and losses, what a margin call actually means, and simple ways to size positions so one bad trade can't wipe out an account.",
    level: "Beginner",
    duration: "15 min",
    lessons: 4,
  ...
  },
  {
    ...
    description:
      "Why every position deserves a predefined exit, how to place SL/TP levels around support and resistance instead of arbitrary distances, and common mistakes to avoid.",
    level: "Beginner",
    duration: "10 min",
    lessons: 3,
    category: "Risk Management",
  ...
  },
  {
    ...
    description:
      "How to identify the price levels where buying or selling pressure has repeatedly shown up, and how traders use them to plan entries and exits.",
    level: "Beginner",
    duration: "14 min",
    lessons: 5,
    category: "Technical Analysis",
  ...
  },
  {
    ...
    description:
      "The difference between simple and exponential moving averages, how crossovers are used as trend signals, and their limits in choppy markets.",
    level: "Intermediate",
    duration: "16 min",
    lessons: 5,
    category: "Technical Analysis",
  ...
  },
  {
    ...
    description:
      "What the Relative Strength Index measures, how overbought/oversold readings are typically interpreted, and why RSI works best combined with other confirmation.",
    level: "Intermediate",
    duration: "13 min",
    lessons: 4,
    category: "Technical Analysis",
  ...
  },
  {
    ...
    description:
      "How the Sydney, Tokyo, London and New York sessions overlap, why volatility and spreads shift throughout the day, and when major pairs tend to move most.",
    level: "Beginner",
    duration: "11 min",
    lessons: 4,
  ...
  },
  {
    ...
    description:
      "A framework for deciding how much to risk per trade based on account size and stop-loss distance, so a losing streak stays survivable.",
    level: "Intermediate",
    duration: "12 min",
    lessons: 3,
    category: "Risk Management",
  ...
  },
  {
    ...
    description:
      "Why emotional decision-making is the most common reason disciplined strategies fail in practice, and habits that help keep a trading plan intact under stress.",
    level: "Intermediate",
    duration: "17 min",
    lessons: 5,
  ...
  },
  {
    ...
    description:
      "The core pieces every trading plan needs: market focus, entry/exit rules, risk limits and a review process, plus a simple template to start from.",
    level: "Advanced",
    duration: "20 min",
    lessons: 6,
    category: "Strategy",
  ...
  },
  {
    ...
    description:
      "How scalping, day trading, swing trading and position trading map to different chart timeframes, and how to pick one that fits the time you actually have.",
    level: "Beginner",
    duration: "9 min",
    lessons: 3,
    category: "Market Structure",
...
async function main() {
  ...
  for (const course of courses) {
    const existing = await prisma.educationCourse.findFirst({ where: { title: course.title } });
    if (existing) {
      skipped += 1;
      continue;
    }
    await prisma.educationCourse.create({ data: course });
    created += 1;
  }
